...
palindromify str
             ...
             | otherwise           = palindromify (reverse (tail (reverse (tail str)))) 
...
addEithers (Right integer1) (Right integer2) =  Right (integer1 + integer2)
addEithers (Left str) (Right interger) =Left str
addEithers (Left str) (Left str2) =Left str
addEithers (Right integer) (Left str2) =Left str2